...
*/
  ...
  * @param appender_file_id the appender file id
	...
	* @return 0 success, return none zero errno if fail
	*/
	public int download_file1(String file_id, long file_offset, long download_bytes, String local_filename,boolean begin) throws IOException, MyException
	{
		String[] parts = new String[2];
		this.errno = this.split_file_id(file_id, parts);
		if (this.errno != 0)
		...
		return this.download_file(parts[0], parts[1], file_offset, download_bytes, local_filename,begin);
	}
}
